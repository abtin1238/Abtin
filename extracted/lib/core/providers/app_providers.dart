...
import '../../features/settings/data/vehicle_download_service.dart';
...
/// ---- سرویسِ دانلودِ خودروهای سه‌بعدی (GLB) ----
final vehicleDownloadServiceProvider = Provider<VehicleDownloadService>((ref) {
  AppDatabase? db;
  try {
    db = ref.watch(appDatabaseProvider);
  } catch (_) {}
  return VehicleDownloadService(db);
});
