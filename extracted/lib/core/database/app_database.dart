...
class AppDatabase {
  ...
  Future<void> _migrate() async {
    ...
    if (current < 2) {
      // نسخه‌ی ۲: افزودنِ هشدارهای «سرعت‌گیر» و دوربین‌های بیشتر برای نصب‌های قبلی.
      _seedDefaults();
  ...
  void _seedDefaults() {
    ...
    final hazards = <List<Object?>>[
      ['hz_cam_1', 'speed_camera', 'دوربین کنترل سرعت', 35.7200, 51.4050, 60, 90.0],
      ['hz_cam_2', 'speed_camera', 'دوربین کنترل سرعت', 35.7280, 51.3980, 50, 90.0],
      ['hz_cam_3', 'speed_camera', 'دوربین کنترل سرعت', 35.7380, 51.4060, 70, 90.0],
      ['hz_bump_1', 'speed_bump', 'سرعت‌گیر', 35.7180, 51.4020, null, 60.0],
      ['hz_bump_2', 'speed_bump', 'سرعت‌گیر', 35.7330, 51.4090, null, 60.0],
      ['hz_bump_3', 'speed_bump', 'سرعت‌گیر', 35.7250, 51.3930, null, 60.0],
