...
/// نوعِ هشدارِ نمایش‌داده‌شده در نوارِ هشدارِ زیرِ نوارِ بالا.
/// **فقط** این دو نوع مجاز به نمایش در تابلوی هشدار هستند؛ سایرِ نقاطِ
/// محلی (مدرسه، تونل، ایست بازرسی و ...) فقط با صدا اعلام می‌شوند و روی
/// تابلو ظاهر نمی‌شوند.
enum HazardBannerType { speedCamera, speedBump }

/// اطلاعاتِ هشدارِ فعالِ فعلی برای نمایش در تابلوی هشدار.
class HazardBannerInfo {
  final HazardBannerType type;
  final String title;
  final double distanceMeters;
  const HazardBannerInfo({
    required this.type,
    required this.title,
...
class NavigationState {
  ...
  /// هشدارِ فعالِ تابلو (فقط دوربین کنترل سرعت / سرعت‌گیر) — null یعنی هشداری نیست.
  final HazardBannerInfo? hazardBanner;
  ...
  NavigationState copyWith({
    ...
    HazardBannerInfo? hazardBanner,
    bool clearHazardBanner = false,
  }) =>
      NavigationState(
        ...
        hazardBanner:
            clearHazardBanner ? null : (hazardBanner ?? this.hazardBanner),
      );
}
