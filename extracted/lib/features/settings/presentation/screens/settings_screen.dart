...
import 'vehicle_download_screen.dart';
...
class SettingsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final navItems = <_SettingItem>[
      ...
      const _SettingItem(Icons.directions_car_rounded, 'دانلود خودرو',
          'دانلود مدل‌های سه‌بعدی خودرو (GLB) و انتخاب نشانگر',
          page: VehicleDownloadScreen()),
