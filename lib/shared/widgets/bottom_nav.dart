...
///
/// بک‌گراند منو به‌جای گرادینت، از عکس `assets/images/bottom_nav_bg.png` است
/// (بک‌گراند سفید حذف شده و کمی شفاف است) و آیکون‌ها روی آن می‌نشینند؛
/// آیتم وسط با ترنسفورم به‌سمت بالا داخل برآمدگی وسط عکس جا می‌گیرد.
    ...
    return Align(
      ...
      child: SizedBox(
        ...
        child: Stack(
          ...
          alignment: Alignment.bottomCenter,
          children: [
            // لایه بک‌گراند: عکس دلخواه به‌جای گرادینت‌های قبلی، با کمی شفافیت
            Positioned(
              left: -8,
              right: -8,
              bottom: 0,
            ...
            // لایه آیکون‌ها روی عکس بک‌گراند
            Positioned(
              left: 20,
              right: 20,
              bottom: 22,
