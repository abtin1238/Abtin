                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 16),
                      const Text('جنسیت گوینده', style: TextStyle(color: Colors.white, fontSize: 13)),
                      ...
                      const Text('صدای گوینده', style: TextStyle(color: Colors.white, fontSize: 13)),
                      const SizedBox(height: 8),
                      ...
                      _TestVoiceButton(),
                      const SizedBox(height: 20),
                      const Text('موتور تبدیل متن به گفتار (TTS)', style: TextStyle(color: Colors.white, fontSize: 13)),
                      const SizedBox(height: 8),
                      _OptionRow(
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(label, style: const TextStyle(color: Color(0xFFF0F2F4), fontSize: 13)),
                if (desc != null) ...[
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text(valueLabel, style: const TextStyle(color: AppColors.subAccentA, fontWeight: FontWeight.bold, fontSize: 13)),
        SliderTheme(
        ...
        child: Row(
          ...
          children: [
            ...
            Text(
              ...
              style: const TextStyle(color: AppColors.subAccentA, fontWeight: FontWeight.bold, fontSize: 13),
            ),
          ],
        ),
      ),
