        ...
        children: [
          ...
          Expanded(
            child: Text(label,
                ...
                style: const TextStyle(color: Color(0xFFF0F2F4), fontSize: 14)),
          ),
        ],
      ),
    );
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(time, style: const TextStyle(color: Color(0xFFD5D9DD), fontSize: 13)),
          Text(distance, style: const TextStyle(color: Color(0xFFD5D9DD), fontSize: 13)),
          Text(note, style: const TextStyle(color: Color(0xFFD5D9DD), fontSize: 13)),
        ],
      ),
    );
  }
