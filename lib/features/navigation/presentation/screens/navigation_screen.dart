...
import '../widgets/nav_arrow_marker.dart';
      ...
      child: Scaffold(
        body: Stack(
          children: [
              ...
              Positioned(
                ...
                child: Column(
                  children: [
                    ...
                    if (nav.hazardBanner != null) ...[
                      const SizedBox(height: 8),
                      HazardBanner(info: nav.hazardBanner!),
                    ],
                    const SizedBox(height: 8),
                    const Align(
            ...
            // ---- سرعت‌سنج (همیشه ثابت پایین‌چپ) + تابلوی محدودیتِ داینامیکِ
            // کوچیک‌تر درست زیرِ آن (دقیقاً مطابق تصویر مرجع). بدون هیچ دکمه‌ی
            // ضربدرِ اضافه روی سرعت‌سنج — بستنِ ناوبری فقط از X نوارِ مانور است.
            Positioned(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (nav.shouldShowSpeedLimit && nav.speedLimitKmh != null) ...[
                    const SizedBox(height: 8),
                    SpeedLimitSign(limit: nav.speedLimitKmh!, size: 52),
                  ],
                ],
              ),
            ),
