...
class NavigationState {
  ...
  /// نوعِ هشدارِ فعالِ نزدیک (فقط `speed_camera` و `speed_bump`). null یعنی هشداری نیست.
  final String? hazardType;

  /// عنوانِ هشدارِ فعال برای نمایش در نوارِ هشدار.
  ...
  NavigationState copyWith({
    ...
    bool clearHazard = false,
      ...
      NavigationState(
        ...
        hazardType: clearHazard ? null : (hazardType ?? this.hazardType),
        hazardTitle: clearHazard ? null : (hazardTitle ?? this.hazardTitle),
      );
}
