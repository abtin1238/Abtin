                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _MenuRow(
                        ...
                        chevron: true,
                        onTap: () => context.go('/voice-settings'),
                      ),
      ...
      builder: (ctx) {
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              const Text('انتخاب خودرو', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 16)),
