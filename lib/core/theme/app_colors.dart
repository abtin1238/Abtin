...
class AppColors {
  ...
  // ---- نشانگرِ پیکانِ سه‌بعدیِ روی نقشه (شیشه‌ای/نارنجی، مطابق تصویر مرجع) ----
  static const Color arrowOrangeLight = Color(0xFFFFC98A);
  static const Color arrowOrange = Color(0xFFFF9A3D);
  static const Color arrowOrangeDeep = Color(0xFFE85D10);
  static const Color arrowOrangeShadow = Color(0xFF8A2E05);
  static const Color arrowGlow = Color(0xFFFF7A1A);
